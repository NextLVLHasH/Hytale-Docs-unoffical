...
- [RemovedAssetsEvent](./removed-assets-event.md) - Fired when assets are removed from a store
- [GenerateAssetsEvent](./generate-assets-event.md) - Fired to generate derived assets from loaded ones
